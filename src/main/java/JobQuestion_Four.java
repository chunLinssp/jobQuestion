...
public class JobQuestion_Four {
    ...
    public static void main(String[] args) {
        ...
        int item10_apple = calculate2(new Strawberry(8), 1);
        int item11_strawberry = calculate2(new Apple(13), 1);
        int item12_mango = calculate2(new Mango(20), 1);
        int sum5 = item10_apple + item11_strawberry + item12_mango;
        double sum5_new_place = joinActivity2(sum5);
        System.out.println("方法２ 满 100 减 10 块，　得出客户购买商品总价" + sum3);
     ...
     * @return
     */
    public static double joinActivity2(int place) {
        if(place >= 100)
            return place - 10;
